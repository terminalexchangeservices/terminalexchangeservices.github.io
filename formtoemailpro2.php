...
$my_email = "info@terminalexchangeservices.com";
...
$continue = "http://terminalexchangeservices.com";
...
// put location in subject -- SL

$subject = stripslashes($subject) . " - " . $_REQUEST['Need_Location'] . ", " . $_REQUEST['State_Needed'];
...
<br>
Your message has been sent to TXS.
<p><a href="<?php print $continue; ?>">Click here to return to the TXS website.</a></p>
</center>
</div>
